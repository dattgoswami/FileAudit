...
function process_textfile(filename) {
    return __awaiter(this, void 0, void 0, function () {
        var filenameSet, resultExtensionCounter, extensionCounterMap, filePath, lineReader;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filenameSet = new Set();
                    resultExtensionCounter = {};
                    extensionCounterMap = new Map();
                    filePath = '../assets/' + filename;
                    lineReader = readline_1.default.createInterface({
                    ...
                    return [4 /*yield*/, (0, events_1.once)(lineReader, 'close')];
                case 1:
                    _a.sent();
                    ...
                    return [2 /*return*/, resultExtensionCounter];
            }
        });
    });
}
