...
var process_json_1 = __importDefault(require("../../utilities/process_json"));
var data_json_1 = __importDefault(require("../../assets/data.json"));
var process_textfile_1 = __importDefault(require("../../utilities/process_textfile"));
var extensions = express_1.default.Router();
...
extensions.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, process_textfile_1.default)('data.txt')];
            case 1:
...
// this is for the case when data is in json format
//we are reading it from the file src/assets/data.json
extensions.get('/json', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result_json;
    return __generator(this, function (_a) {
        result_json = (0, process_json_1.default)(data_json_1.default);
